    ...
    return (
      <div className="relative mx-auto flex h-[72vh] max-w-5xl items-end justify-center overflow-hidden rounded-[2rem] border border-white/10 bg-black/70 p-6 shadow-card">
        ...
        <div className="relative z-10 max-w-xl text-center">
          <p className="text-sm uppercase tracking-[0.35em] text-gold">Immersive mobile flavor</p>
    ...
    <div className="relative h-[100vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm uppercase tracking-[0.35em] text-gold drop-shadow-[0_1px_6px_rgba(0,0,0,0.9)]">Premium Indian cuisine</p>
